		...
		<!-- Header -->
			<header id="header">
				<div class="inner">
					...
					<nav id="nav">
					<a href="#home">HOME</a>
					<a href="category" style="color: white;">CATEGORY</a>
					<a href="supplier" style="color: white;">SUPPLIERS</a>
					<a href="product" style="color: white;">PRODUCTS</a>
					
					<a href="fetchpage">DATA</a>
					<a href="perform_logout" style="color:white;">LOGOUT</a>
